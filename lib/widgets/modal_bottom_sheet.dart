...
class _MapModalBottomSheetState extends State<MapModalBottomSheet> {
  String _id, _qty, _extra_qty, _cuttingstyle_id, _queans;
  ...
  Widget build(BuildContext context) {
    ...
    Future addToCart() async {
      Response response = await cart.addToCart(
          _id, _qty, _extra_qty, _cuttingstyle_id, _queans);
                          ...
                          ButtonTheme(
                            ...
                            child: RaisedButton(
                              ...
                              child: Text(
                                ...
                                style: kstyle(
                                    fontSize: 15,
                                    color: ques1 ? Colors.white : Colors.black),
                              ),
                              color: ques1
                                  ? Color.fromRGBO(245, 131, 33, 1)
                                  : Colors.white,
                            ),
                          ),
                          ButtonTheme(
                            ...
                            child: RaisedButton(
                              ...
                              child: Text(
                                ...
                                style: kstyle(
                                    fontSize: 15,
                                    color:
                                        !ques1 ? Colors.white : Colors.black),
                              ),
                              color: !ques1
                                  ? Color.fromRGBO(245, 131, 33, 1)
                                  : Colors.white,
                          ...
                          ButtonTheme(
                            ...
                            child: RaisedButton(
                              ...
                              child: Text(
                                ...
                                style: kstyle(
                                    fontSize: 15,
                                    color: ques2 ? Colors.white : Colors.black),
                              ),
                              color: ques2
                                  ? Color.fromRGBO(245, 131, 33, 1)
                                  : Colors.white,
                            ...
                            child: RaisedButton(
                              ...
                              child: Text(
                                ...
                                style: kstyle(
                                    fontSize: 15,
                                    color:
                                        !ques2 ? Colors.white : Colors.black),
                              ),
                              color: !ques2
                                  ? Color.fromRGBO(245, 131, 33, 1)
                                  : Colors.white,
